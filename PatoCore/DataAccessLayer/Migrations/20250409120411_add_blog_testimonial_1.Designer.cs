...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20250409120411_add_blog_testimonial_1")]
    partial class add_blog_testimonial_1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EntityLayer.Concrete.Blog", b =>
                {
                    ...
                    b.Property<int>("BlogTestimonialId")
                        .HasColumnType("int");

                    b.Property<int>("BlogTestimonialsID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EntityLayer.Concrete.Blog", b =>
                {
                    ...
                    b.HasOne("EntityLayer.Concrete.BlogTestimonials", "BlogTestimonials")
                        .WithMany("Blog")
                        .HasForeignKey("BlogTestimonialsID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
